...
class OnboardingSlidesCart extends StatelessWidget {
  const OnboardingSlidesCart({
    super.key,
    required this.onbordingSlide,
    required this.onbordingSlideweb,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Column(
        ...
        children: [
          Text(
            onbordingSlide.label,
            style: TextStyle(fontSize: 24, color: AppColors.fullBlack),
          ),
          Text(
            onbordingSlide.subTitle,
            style: TextStyle(fontSize: 18, color: AppColors.fullBlack),
          ),
          SizedBox(
          ...
          Card(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(
                  20), // Ensures the image also has rounded corners
              child: isWeb
                  ? SizedBox(
